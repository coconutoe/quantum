...
//        }
    ...
    public int showCcnotDialog(String data) throws IOException {
    	CcnotController ccnot = (CcnotController)showpane("view/Ccnot.fxml",data);
        return ccnot.isAdd();
        // return controller.isAdd();
    }
    
    public int showCnotsDialog(String data) throws IOException {
    	CnotsController cnots = (CnotsController)showpane("view/Cnots.fxml",data);
        return cnots.isAdd();
        // return controller.isAdd();
    }
