...
//        }
    ...
    private ASTList ccnotOp() {
        ...
        list.add(argument2);
        list.add(argument3);
        return new List_CcnotOP(list);
    }
    
  //cnots
    private ASTList cnotsOp() {
        ASTLeaf bOperator;
        List<ASTree> list = new ArrayList<ASTree>();
        ASTLeaf argument;
        ...
        bOperator = new Leaf_BOperator(lookahead);
        list.add(bOperator);
        match(TokenType.CnotsOp);
        while((argument = argument()) != null) {
        	list.add(argument);
        }
        
        return new List_CnotsOP(list);
    }
